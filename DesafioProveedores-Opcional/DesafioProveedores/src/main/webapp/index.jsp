            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edicion.jsp?id=<%= proveedor.getId() %>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="MainServlet?action=delete&id=<%= proveedor.getId() %>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este proveedor?');">Eliminar</a>
                        </td>
                    </tr>
                    <%
                        }
